...
Function UpdateSky()
	if sky <> 0 then PositionEntity Sky, EntityX(Camera, True),EntityY(Camera, True),EntityZ(Camera, True), True
End Function

Function Update1499Sky()
	if i_1499\sky <> 0 then PositionEntity I_1499\Sky, EntityX(Camera, True),EntityY(Camera, True),EntityZ(Camera, True), True
End Function
